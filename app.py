...
If you don't know the answer or the user's question is not related to the context, just say that you don't know, don't try to make up an answer.

Context: {context}
Question: {question}

Only return the helpful answer below and nothing else. Always remember that all Answer in VietNamese.
Helpful answer:
"""
...
async def start():
    ...
    welcome_message.content = (
        "Chào bạn, tôi là một trợ lý ảo, hãy đặt các câu hỏi về Chuyển đổi số."
    )
